    ...
    <div style="width:100%;">
        ...
        <div style="font-weight: bold; color: rgb(233, 80, 80);width:100%;  ">
            ...
            <span style="color: #aaa; ">
                <br>
                <?php echo  Time::get_time($Row['timeAsked'])?>
        ...
        ?>
        <a href="single_post.php?id=<?php echo $Row['questionid'] ?>" style=" color:black;text-decoration:none;">
        <img src="../images/answer.png"  style="width:25px;height:25px;">
        <?php echo $answers?></a>
